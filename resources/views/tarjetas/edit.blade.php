{{-- resources/views/tarjetas/edit.blade.php --}}
<x-app-layout>
    {{-- Encabezado (Tabler) --}}
                    ...
                    <div class="card">
                        ...
                        <form method="POST" action="{{ route('tarjetas.update', $tarjeta) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-icon">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('fecha_vencimiento', \Carbon\Carbon::parse($tarjeta->fecha_vencimiento)->format('Y-m')) }}"
                            ...
                            <div class="card-footer d-flex gap-2">
                                ...
                                <a href="{{ route('tarjetas.index') }}" class="btn btn-link">
                                    Cancelar
                                </a>
                            </div>
                        </form>
    ...
    {{-- Script mínimo para mostrar/ocultar NIP --}}
    <script>
        (function () {
